  ...
  <div id="block">
    ...
    <div class="right_block">
      <main class="main_admin">
        <h2 class="h2_admin">{{ t('pages.theme_modification_page.header_title') }}</h2>
      </main>
      <div id="dashbord">
        <div id="formulaire_question">
          <div class="form-box">
            <form class="form" @submit.prevent="updatetheme" v-if="data">
              ...
              <span class="title">{{ t('pages.theme_modification_page.form_title') }}</span>
              <span class="subtitle">{{ t('pages.theme_modification_page.form_subtitle') }}</span>
              <div class="form-container">
                <label for="theme" class="theme_label">
                  {{ t('pages.theme_modification_page.label_theme') }} :
                  <input class="form_input" type="text" name="theme" :placeholder="data.nomThemes" v-model="theme" required>
                </label>
                <label for="theme_en">
                  {{ t('pages.theme_modification_page.label_theme_en') }} :
                  <input class="form_input" type="text" name="theme_en" :placeholder="data.enThemes" v-model="theme_en" required>
                </label>
              </div>
              <button @click="updatetheme" class="Button_edit">{{ t('pages.theme_modification_page.edit_button_text') }}
