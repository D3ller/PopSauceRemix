<template>
    <div id="block">
     ...
     <div class="right_block">
      ...
      <h2 class="h2_admin">Modification Question</h2>
     </main>
     <div id="dashbord">
       <div id="formulaire_question">
               <div class="form-box">
                 <form class="form" @submit.prevent="updatetheme" v-if="data">
                   ...
                   <span class="title">Modifier la Question</span>
                <span class="subtitle">Veuillez remplir le formulaire pour modififer la question.</span>
                <div class="form-container">
                  <input class="form_input" type="text" v-model="question" :placeholder="data.question" name="question" >
                  <input class="form_input" type="text" v-model="question_en" :placeholder="data.question_en"
                    name="question_en" >
                  <input class="form_input" type="text" v-model="reponse_1" :placeholder="data.reponse_1" name="reponse1" >
                  <input class="form_input" type="text" v-model="reponse_1_en" :placeholder="data.reponse_1_en"
                    name="reponse1_en" >
                  ...
                  <input class="form_input" type="text" v-model="reponse_2" :placeholder="data.reponse_2" name="reponse2">
                  <input class="form_input" type="text" v-model="reponse_2_en" :placeholder="data.reponse_2_en" name="reponse2_en" >
                  <input class="form_input" type="text" v-model="reponse_3" :placeholder="data.reponse_3" name="reponse3" >
                  <input class="form_input" type="text" v-model="reponse_3_en":placeholder="data.reponse_3_en" name="reponse3_en" >
                  <input class="form_input" type="text" v-model="reponse_4" :placeholder="data.reponse_4" name="reponse4" >
                  <input class="form_input" type="text" v-model="reponse_4_en" :placeholder="data.reponse_4_en" name="reponse4_en">
                  <input class="form_input" type="text" v-model="bonne_reponse" :placeholder="data.bonne_reponse" name="bonne_reponse">
                  <input class="form_input" type="text" v-model="good_reponse" :placeholder="data.good_reponse" name="good_reponse">
                  </div>
